...
DETAIL_TEMPLATES = {
    ...
    "comprehensive": (
        ...
        "Printout showing the Clean Retail Value of the unit may include NADA, J.D. Power, Kelly Blue Book, Edmunds, Carfax, or Cars.com. Do not report as missing if any of these are present. "
