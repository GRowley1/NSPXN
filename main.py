...
# Use GPT-5.1 everywhere
MODEL = os.getenv("OAI_MODEL", "gpt-5.1")
...
DETAIL_TEMPLATES = {
    ...
    "comprehensive": (
        ...
        "If a Printout showing the Clean Retail Value of the unit is present which may include ANY of the following: NADA, J.D. Power, Kelly Blue Book, Edmunds, Carfax, or Cars.com, DO NOT declare as missing if any of these are present. "
